var game = new Phaser.Game(800, 400, Phaser.CANVAS, 'gameCanvas', { preload: preload, create: create, update: update, render: render }); // (ancho, alto, ...
var map;
var layer;
var mapa;
...
function create() 
{
    game.world.setBounds(0, 0, 3000, 300);
    ...
    *****************************************/
    ...
    var ground = platforms.create(35, 300, 'ground');
    ...
    *****************************************/
    ...
    player1 = game.add.sprite(35, 238, 'yoshi');

    player2 = game.add.sprite(20, 238, 'yoshi2');
