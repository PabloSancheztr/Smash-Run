    ...
    *****************************************/
	...
	connection.onmessage = function(msg) {
		...
		if(numMsg){
			...
			player2.body.velocity.x = dato;
			numMsg = false;
		}else{
			console.log("WS message: y = " + dato);
			player2.body.velocity.y = dato;
			numMsg = true;
		}
	}
}
...
function update() 
{
    ...
    *****************************************/
    ...
    if(websocket)
    {
    	...
    	connection.send(player1.body.velocity.x);
    	connection.send(player1.body.velocity.y);
    }
    websocket = false;
}
...
function quien_gana(){
	...
	if(score1 > score2)
	{
		...
		nombre2 = prompt("Blue tu puntuacion ha sido de " + score2 + " puntos \n Introduce tu nombre: ");
		
		postPuntos(nombre1, score1);
		postPuntos(nombre2, score2);
	}
	else if(score2 > score1)
	{
		nombre2 = prompt("¡Blue has ganado con " + score2 + " puntos! \n Introduce tu nombre: ");
		nombre1 = prompt("Green tu puntuacion ha sido de " + score1 + " puntos \n Introduce tu nombre: ");
