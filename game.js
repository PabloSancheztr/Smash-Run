var game = new Phaser.Game(800, 600, Phaser.AUTO, 'container', { preload: preload, create: create, update: update }); // ancho, alto
...
function preload()
{
    ...
    game.load.spritesheet('yoshi', 'assets/yoshi_run.png', 34.6, 45);
}
